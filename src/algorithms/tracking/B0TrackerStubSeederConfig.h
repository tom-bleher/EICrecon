...
/// the result is back-extrapolated analytically to the origin perigee used by CKFTracking for a zero surface ID.
struct B0TrackerStubSeederConfig {
  ...
  /// of displaced decays needs a seed anchored away from the origin, as provided separately by B0TrackerActsSeeding.
